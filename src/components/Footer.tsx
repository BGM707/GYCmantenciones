      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <button onClick={() => setCurrentSection('inicio')} className="hover:text-white transition-colors cursor-pointer">
                  Inicio
                </button>
              </li>
              <li>
                <button onClick={() => setCurrentSection('servicios')} className="hover:text-white transition-colors cursor-pointer">
                  Servicios
                </button>
              </li>
              <li>
                <button onClick={() => setCurrentSection('nosotros')} className="hover:text-white transition-colors cursor-pointer">
                  Sobre Nosotros
                </button>
              </li>
              <li>
                <button onClick={() => setCurrentSection('postulaciones')} className="hover:text-white transition-colors cursor-pointer">
                  Trabaja con Nosotros
                </button>
              </li>
              <li>
                <button onClick={() => setCurrentSection('politicas')} className="hover:text-white transition-colors cursor-pointer">
                  Políticas
                </button>
              </li>
              <li>
                <button onClick={() => setCurrentSection('contacto')} className="hover:text-white transition-colors cursor-pointer">
                  Contacto
                </button>
              </li>
            </ul>
