...
export default function Whistleblower({ setCurrentSection }: WhistleblowerProps) {
  return (
    <section id="denuncias" className="py-20 bg-gradient-to-br from-slate-900 to-slate-800 relative overflow-hidden min-h-screen pt-32 pb-12 flex flex-col">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex-grow flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 animate-in slide-in-from-top duration-700 delay-200">
        ...
        <div className="max-w-2xl mx-auto animate-in slide-in-from-top duration-700 delay-300">
      ...
      <div className="flex justify-center pt-8">
        <button
          ...
          className="px-6 py-3 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-all duration-300 shadow-md hover:shadow-lg"
        >
          Volver al Inicio
        </button>
      </div>
